...
def generate_overall_joint_rmse_bar_plot(rmse_dataframe):
    rmse_barplot_html = ""
...
def generate_marker_specific_html(marker, dataframe_of_3d_data, rmse_dataframe):
    ...
    marker_specific_html += rmse_table_html  # Add the table to the content
...
def generate_html_report(dataframe_of_3d_data, rmse_dataframe, filename="trajectory_report.html"):
    ...
    html_content += generate_overall_rmse_indicators_html(rmse_dataframe)

    html_content += generate_overall_joint_rmse_bar_plot(rmse_dataframe)

    for marker in unique_markers:
        html_content += generate_marker_specific_html(marker, dataframe_of_3d_data, rmse_dataframe)
