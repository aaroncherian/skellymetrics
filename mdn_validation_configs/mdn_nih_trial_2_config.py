...
path_to_recording = Path(r"D:\2023-05-17_MDN_NIH_data\1.0_recordings\calib_3\sesh_2023-05-17_14_40_56_MDN_NIH_Trial2")
...
mdn_nih_trial_2_mediapipe_config = RecordingConfig(
    recording_name='MDN NIH Trial 2 Mediapipe RANSAC',
    path_to_recording=path_to_recording,
