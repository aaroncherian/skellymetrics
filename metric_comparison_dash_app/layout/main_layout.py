...
from .cards.rmse_change_plot_card import get_rmse_change_plot_card
...
def get_layout(marker_figure, rmse_change_figure, list_of_marker_buttons, color_of_cards):
    sidebar = dbc.Col(
        [
    ...
    main_content = dbc.Col(
        [
            ...
            dbc.Row([
                dbc.Col(get_rmse_change_plot_card(rmse_change_figure, color_of_cards),)
            ]),
            dbc.Row([
